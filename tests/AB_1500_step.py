...
f = open('AB_1500_STEP.csv', 'w')#file to write chain data in
print('Loading...')
pdb = PDBFile('AB.pdb')
...
integrator = LangevinIntegrator(5*kelvin, 1/picosecond, 0.001*picoseconds)
...
simulation.reporters.append(StateDataReporter(f, 1000, step=True,kineticEnergy=True,
